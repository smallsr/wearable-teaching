...
2. Extract and process accelerometer data.
...
# 3. Coffee break
After you have set up the camera and accelerometer to begin recording, we will take a coffee break. The images collected during this break will give us an opportunity to practice annotating images after the break!

# 4. Practice annotating reference camera data


# 5. Practice downloading your own camera data

# 6. Collecting your own data in-the-wild
